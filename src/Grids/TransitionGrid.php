...
class TransitionGrid extends Grid
{
    protected function setup()
    {
        ...
        $this->addEditAction(trans('motor-admin::backend/global.edit'), 'backend.transitions.edit');
        $this->addDeleteAction(trans('motor-admin::backend/global.delete'), 'backend.transitions.destroy');
    }
}
