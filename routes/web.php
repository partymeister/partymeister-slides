...
Route::get('internal/generate/schedule/{schedule}', function (Request $request, Schedule $schedule) {
    ...
    return view('partymeister-slides::slidemeister-generator.index', [
        ...
        'api_token' => User::find(1)?->api_token ?? abort(500, 'Admin user not found'),
        'headless' => true,
...
Route::group(['middleware' => ['web', 'web_auth', 'bindings']], function () {
    ...
    Route::get('slidemeister-editor/template/{slide_template}', function (SlideTemplate $slideTemplate) {
        return view('partymeister-slides::slidemeister-editor.index', [
    ...
    Route::get('slidemeister-editor/slide/{slide}', function (Slide $slide) {
        return view('partymeister-slides::slidemeister-editor.index', [
            'editor_mode' => 'slide',
            'entity_id' => $slide->id,
            'api_token' => auth()->user()->api_token,
    ...
    Route::get('slidemeister-generator/competition/{competition}', function (Competition $competition) {
        return view('partymeister-slides::slidemeister-generator.index', [
    ...
    Route::get('slidemeister-generator/schedule/{schedule}', function (Schedule $schedule) {
        return view('partymeister-slides::slidemeister-generator.index', [
            'generator_type' => 'timetable',
            'schedule_id' => $schedule->id,
            'api_token' => auth()->user()->api_token,
    ...
    Route::get('slidemeister-generator/event/{event}', function (Event $event) {
        return view('partymeister-slides::slidemeister-generator.index', [
